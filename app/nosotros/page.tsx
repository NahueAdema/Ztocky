...
function ValueCard({
  ...
  return (
    <div className="group relative rounded-2xl border border-border bg-card-white p-6 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
      <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-soft-teal text-primary">
...
export default function NosotrosPage() {
  return (
    <main className="min-h-screen bg-background antialiased">
      {/* ── HERO ─────────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-soft-teal">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
          ...
          <div className="max-w-2xl">
            <h1 className="text-4xl font-extrabold uppercase leading-[1.08] tracking-tight text-foreground sm:text-5xl">
              Hecho por alguien que
              <br />
              <span className="text-primary">entiende el problema</span>
            </h1>
            <p className="mt-6 text-base leading-7 text-muted-foreground/80 sm:text-lg">
              Ztocky nace de una necesidad real: que las PyMEs de Latinoamérica tengan el mismo control de stock que una multinacional, sin pagar como una.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-[auto_1fr] lg:items-center">
          <div className="flex justify-center">
            <div className="relative h-48 w-48 overflow-hidden rounded-full border-4 border-soft-teal bg-card-white shadow-xl sm:h-56 sm:w-56">
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold text-foreground sm:text-4xl">Nahuel Adema</h2>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a href="https://github.com/NahueAdema" target="_blank" rel="noopener noreferrer"
                className="inline-flex h-10 items-center gap-2 rounded-full border border-border bg-card px-5 text-sm font-medium text-muted-foreground transition-all duration-200 hover:bg-muted">
      ...
      {/* ── VALUES ───────────────────────────────────────────────────────── */}
      <section className="border-y border-border bg-card-white">
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
          <div className="mb-12 max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-widest text-primary">Lo que nos mueve</p>
            <h2 className="mt-3 text-3xl font-bold text-foreground sm:text-4xl">Por qué hacemos esto</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
        <div className="mb-12 max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-widest text-primary">Hoja de ruta</p>
            <h2 className="mt-3 text-3xl font-bold text-foreground sm:text-4xl">Hacia dónde vamos</h2>
        </div>
        <div className="grid gap-6 sm:grid-cols-3">
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-base font-semibold text-card-foreground">Compras inteligentes</h3>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card-white p-6 shadow-sm">
            <div className="absolute right-0 top-0 h-20 w-20 translate-x-6 -translate-y-6 rounded-full bg-primary/5" />
            <span className="inline-flex items-center justify-center rounded-full bg-warning-light px-3 py-1 text-xs font-bold text-warning">Próximo</span>
            <h3 className="mt-4 text-base font-semibold text-card-foreground">Portal del proveedor</h3>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border bg-card-white p-6 shadow-sm">
            <div className="absolute right-0 top-0 h-20 w-20 translate-x-6 -translate-y-6 rounded-full bg-primary/5" />
            <span className="inline-flex items-center justify-center rounded-full bg-indigo-light px-3 py-1 text-xs font-bold text-indigo">Futuro</span>
            <h3 className="mt-4 text-base font-semibold text-card-foreground">Red de proveedores</h3>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
      ...
      <section className="bg-soft-teal">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-2xl font-bold text-foreground sm:text-3xl">Formá parte de esto</h2>
            <p className="mt-3 max-w-md text-sm leading-6 text-muted-foreground/80">
              Si tenés un comercio o trabajás con proveedores, Ztocky está pensado para vos. Probarlo no cuesta nada.
            </p>
            <Link href="/login?mode=register" className="mt-6 inline-flex h-11 items-center gap-2 rounded-full bg-primary px-7 text-sm font-semibold text-white shadow-lg shadow-primary/30 transition-colors hover:bg-primary-dark">
